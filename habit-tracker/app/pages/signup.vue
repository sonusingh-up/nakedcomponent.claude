...
<template>
  <div class="flex flex-1 flex-col justify-center py-10">
    <div class="mb-8 text-center">
      ...
      <h1 class="display-serif text-3xl text-stone-900">Start building habits</h1>
      <p class="mt-1 text-sm text-stone-500">Create your free account</p>
    </div>
    ...
    <p class="mt-8 text-center text-sm text-stone-500">
      ...
      <NuxtLink to="/login" class="font-semibold text-terracotta-600">
        Sign in
      </NuxtLink>
    </p>
  </div>
